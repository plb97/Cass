...
public class Cluster {
    ...
    @discardableResult
    public func setContactPoints(_ contact_points: String) -> Self {
        if .ok == error_code {
    ...
    @discardableResult
    public func setPort(_ port: Int = 9042) -> Self {
        if .ok == error_code {
    ...
    @discardableResult
    public func setSsl(_ ssl: Ssl) -> Self {
         cass_cluster_set_ssl(cluster, ssl.cass)
         return self
    }
    @discardableResult
    public func setAuthenticatorCallbacks(_ authenticatorCallbacks: AuthenticatorCallbacks) -> Self {
    ...
    @discardableResult
    public func setProtocolVersion(_ protocol_version: ProtocolVersion = .v4) -> Self {
        if .ok == error_code {
    ...
    @discardableResult
    public func setNumThreadsIo(_ num_threads: Int = 1) -> Self {
        if .ok == error_code {
    ...
    @discardableResult
    public func setQueueSizeIo(_ queue_size: Int = 8192) -> Self {
        if .ok == error_code {
    ...
    @discardableResult
    public func setQueueSizeEvent(_ queue_size: Int = 8192) -> Self {
        if .ok == error_code {
    ...
    @discardableResult
    public func setCoreConnectionsPerHost(_ num_connections: Int = 1) -> Self {
        if .ok == error_code {
    ...
    @discardableResult
    public func setMaxConnectionsPerHost(_ num_connections: Int = 2) -> Self {
        if .ok == error_code {
    ...
    @discardableResult
    public func setReconnectWaitTime(_ wait_time: Int = 2000) -> Self {
        cass_cluster_set_reconnect_wait_time(cluster, UInt32(wait_time))
        return self
    }
    @discardableResult
    public func setMaxConcurrentCreation(_ num_connections: Int = 1) -> Self {
        if .ok == error_code {
    ...
    @discardableResult
    public func setMaxConcurrentRequestsThreshold(_ num_requests: Int = 100) -> Self {
        if .ok == error_code {
    ...
    @discardableResult
    public func setMaxRequestsPerFlush(_ num_requests: Int = 128) -> Self {
        error_code = Error(cass_cluster_set_max_requests_per_flush(cluster, UInt32(num_requests)))
        return self
    }
//    @discardableResult
//    public func setWriteBytesHighWaterMark(_ num_bytes: Int = 64 * 1024) -> Self {
//        if .ok == error_code {
...
//    }
//    @discardableResult
//    public func setWriteBytesLowWaterMark(_ num_bytes: Int = 32 * 1024) -> Self {
//        if .ok == error_code {
...
//    }
//    @discardableResult
//    public func setPendingRequestsHighWaterMark(_ num_requests: Int = 256) -> Self {
//        if .ok == error_code {
...
//    }
//    @discardableResult
//    public func setPendingRequestsLowWaterMark(_ num_requests: Int = 128) -> Self {
//        if .ok == error_code {
...
//    }
    @discardableResult
    public func setConnectTimeout(_ timeout_ms: Int = 5000) -> Self {
        cass_cluster_set_connect_timeout(cluster, UInt32(timeout_ms))
        return self
    }
    @discardableResult
    public func setRequestTimeout(_ timeout_ms: Int = 12000) -> Self {
        cass_cluster_set_request_timeout(cluster, UInt32(timeout_ms))
        return self
    }
    @discardableResult
    public func setResolveTimeout(_ timeout_ms: Int = 2000) -> Self {
        cass_cluster_set_resolve_timeout(cluster, UInt32(timeout_ms))
        return self
    }
    @discardableResult
    public func setCredentials(username: String = "cassandra", password: String = "cassandra") -> Self {
        cass_cluster_set_credentials(cluster, username, password)
        return self
    }
    @discardableResult
    public func setLoadBalanceRoundRobin() -> Self {
        cass_cluster_set_load_balance_round_robin(cluster)
        return self
    }
    @discardableResult
    public func setLoadBalanceDcAware(local_dc: String = "local", used_hosts_per_remote_dc: UInt = 1, allow_remote_dcs_for_local_cl: Bool = false) -> Self {
        if .ok == error_code {
    ...
    @discardableResult
    public func setTokenAwareRouting(_ enabled: Bool = true) -> Self {
        cass_cluster_set_token_aware_routing(cluster, enabled ? cass_true : cass_false)
        return self
    }
    @discardableResult
    public func setLatencyAwareRouting(_ enabled: Bool = false) -> Self {
        cass_cluster_set_latency_aware_routing(cluster, enabled ? cass_true : cass_false)
        return self
    }
    @discardableResult
    public func setLatencyAwareRoutingSetting(exclusion_threshold: Double = 2.0, scale_ms: UInt64 = 100, retry_period_ms: UInt64 = 10_000, update_rate_ms: UInt64 = 100, min_measured: UInt64 = 50) -> Self {
    ...
    @discardableResult
    public func setRandomizedContactPoint(_ enabled: Bool = true) -> Self {
        if .ok == error_code {
    ...
    @discardableResult
    public func setNoSpeculativeExecutionPolicy() -> Self {
        if .ok == error_code {
